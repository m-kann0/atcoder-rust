...
fn solve(input: &str) -> String {
    ...
    let mut ans = modint::ModInt1000000007::new(0);
    let mut memo: HashMap<usize, modint::ModInt1000000007> = HashMap::new();
    for i in 0..h {
        for j in 0..w {
            ...
            let mut add = modint::ModInt1000000007::new(2).pow(nz - 1);
            let mut a = modint::ModInt1000000007::new(0);
            for _ in 0..count {
                a += add;
                add /= modint::ModInt1000000007::new(2);
            }
            memo.insert(count, a);
            ans += a;
        }
