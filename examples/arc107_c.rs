use std::io::Read;
use crate::modint::ModInt998244353;
...
fn solve(input: &str) -> String {
    ...
    let mut y = ModInt998244353::new(1);
    for group in dsu.groups() {
        y *= fact(group.len());
    }
...
fn fact(n: usize) -> ModInt998244353 {
    let mut result = ModInt998244353::new(1);
    for i in 2..=n {
        result *= ModInt998244353::new(i);
    }
    result
}
